// Shared SOLVA Tailwind preset. Apps set this in their `presets` array and add
// their own `content` globs. Colors map to the CSS variables defined in
// tokens.css, so a single token file drives both themes everywhere.
