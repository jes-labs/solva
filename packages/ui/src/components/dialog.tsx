...
// Modal dialog built on the Radix dialog primitive. The dashboard uses it for
// the connect-source flow. Radix handles focus trapping, escape, and the
// accessible labelling, so we only style the parts.
